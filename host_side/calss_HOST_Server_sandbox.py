...
def receive_daemon():
    ...
    while True:
        ...
        if not data:            
            continue
        print 'Frame - [Header:', data[0], 'value:', str(data[1:-4])  ,' CRC: ', data[-4:] ,' Address: ', str(address ), 'length: ', len(data)
...
#Default Frame settings
	...
	frame_hope_aray = '4E'.decode('hex') + hop_array()
